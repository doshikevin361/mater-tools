      ...
      <div className="relative z-10 mx-auto max-w-7xl space-y-8 p-6">
        ...
        <div className="text-center py-12">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
            Create authentic Twitter accounts with advanced automation, real profile generation, and enterprise-grade
            security features.
          </p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription className="text-slate-600 text-base mt-1">
                  Generate authentic Twitter accounts with real profiles and advanced automation
                </CardDescription>
              </div>
            </div>
          </CardHeader>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-4">
                ...
                <Input
                  ...
                  className="h-14 bg-white border-cyan-300 hover:border-cyan-400 focus:border-cyan-500 transition-colors text-slate-700 text-center text-lg font-semibold"
                  placeholder="1-5"
                />
              ...
              <div className="space-y-4">
                ...
                <Button
                  ...
                  variant="outline"
                  className="w-full h-14 border-cyan-200 text-cyan-700 hover:bg-cyan-50 hover:border-cyan-300 transition-all duration-300 font-semibold text-base bg-transparent"
                >
                  {downloading ? (
                    <>
                      <RefreshCw className="mr-3 h-5 w-5 animate-spin" />
        ...
        <Card className="bg-white/80 backdrop-blur-sm border border-cyan-200/50 shadow-xl">
          ...
          <CardContent className="p-6">
            <div className="rounded-lg border border-cyan-200 bg-white overflow-hidden shadow-sm">
              <Table>
                <TableHeader>
                  <TableRow className="bg-cyan-50 border-cyan-200">
                ...
                <TableBody>
                  {loading ? (
                    ...
                    accounts.map((account) => (
                      <TableRow key={account._id} className="border-cyan-200 hover:bg-cyan-50 transition-colors">
                        ...
                        <TableCell>
                          {account.creationResult?.profileUrl ? (
                            <Button
                              ...
                              className="h-8 w-8 p-0 text-slate-400 hover:text-cyan-600 hover:bg-cyan-50 transition-all"
                            >
