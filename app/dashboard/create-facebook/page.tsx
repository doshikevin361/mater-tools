...
import { Facebook, Download, Copy, Eye, EyeOff, Bell } from "lucide-react"
...
export default function CreateFacebookPage() {
  ...
  const fetchAccounts = async () => {
    try {
      ...
      const response = await fetch(`/api/social-accounts/list?userId=${user.id}&platform=facebook`)
  ...
  const fetchNotifications = async () => {
    try {
      ...
      if (data.notifications) {
        const facebookNotifications = data.notifications.filter((n: Notification) => n.platform === "facebook")
  ...
  const createAccounts = async () => {
    ...
    try {
      ...
      if (data.success) {
        toast.success(`Successfully created ${data.summary.success} Facebook accounts!`)
  ...
  const downloadExcel = async () => {
    try {
      ...
      const user = JSON.parse(userData)
      const response = await fetch(`/api/social-accounts/download?userId=${user.id}&platform=facebook`)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-20 left-20 w-24 h-24 bg-blue-300 rounded-full opacity-20 animate-pulse delay-2000"></div>
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Create multiple Facebook accounts automatically with advanced anti-detection features and real-time
            notifications.
          </p>
        </div>
          ...
          <div className="lg:col-span-2">
            <Card className="bg-white/80 backdrop-blur-sm border-blue-200">
              <CardHeader>
                ...
                <CardDescription>
                  Generate up to 5 Facebook accounts with Indian profiles and temporary emails
                </CardDescription>
              </CardHeader>
            ...
            <Card className="mt-6 bg-white/80 backdrop-blur-sm border-blue-200">
              <CardHeader>
                ...
                <CardDescription>Your Facebook accounts with login credentials</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {accounts.map((account) => (
                    <div key={account._id} className="p-4 border border-blue-200 rounded-lg bg-white/50">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <code className="bg-gray-100 px-2 py-1 rounded text-xs capitalize">{account.gender}</code>
                        </div>
                      </div>
                  ...
                  {accounts.length === 0 && (
                    <div className="text-center py-8 text-gray-500">
                      ...
                      <p>No Facebook accounts created yet</p>
