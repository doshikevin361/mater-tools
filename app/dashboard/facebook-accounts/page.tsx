      ...
      <div className="relative z-10 mx-auto max-w-7xl space-y-8 p-6">
        <div className="text-center py-12">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
            Create authentic Facebook accounts with advanced automation, real profile generation, and enterprise-grade
            security features.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card className="bg-white/70 backdrop-blur-sm border border-blue-200/50 hover:bg-white/80 transition-all duration-300 hover:scale-105 hover:shadow-lg">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription className="text-slate-600 text-base mt-1">
                  Generate authentic Facebook accounts with real profiles and advanced automation
                </CardDescription>
              </div>
            </div>
          </CardHeader>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="space-y-4">
                ...
                <Input
                  ...
                  className="h-14 bg-white border-blue-300 hover:border-blue-400 focus:border-blue-500 transition-colors text-slate-700 text-center text-lg font-semibold"
                  placeholder="1-5"
                />
              ...
              <div className="space-y-4">
                ...
                <Button
                  ...
                  variant="outline"
                  className="w-full h-14 border-blue-200 text-blue-700 hover:bg-blue-50 hover:border-blue-300 transition-all duration-300 font-semibold text-base bg-transparent"
                >
                  {downloading ? (
                    <>
                      <RefreshCw className="mr-3 h-5 w-5 animate-spin" />
                ...
                <TableBody>
                  {loading ? (
                    ...
                    accounts.map((account) => (
                      <TableRow key={account._id} className="border-blue-200 hover:bg-blue-50 transition-colors">
